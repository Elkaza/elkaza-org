...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  de: {
    ...
    what_do_item3_desc: "Application Support, Debugging, XML/XSLT-Publishing-Kontext, User Stories, Anforderungen, Runbooks und klare technische Übergaben.",
  ...
  en: {
    ...
    what_do_item3_desc: "Application support, debugging, XML/XSLT publishing context, user stories, requirements, runbooks and clear technical handovers.",
