...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  de: {
    ...
    cv_summary_text: "Systemadministrator mit Erfahrung im operativen IT-Betrieb und in der Betreuung von Windows-basierten Client-/Server-Umgebungen. Routine in Support, Ticketbearbeitung, strukturierter Fehleranalyse sowie gute Kenntnisse in Netzwerktechnik, Systemwartung, software-naher Automatisierung und Application-Engineering-naher Integrationsarbeit. Daten-/Prozessanalyse, Business-Analysis-nahe Arbeitsweise sowie IoT, Security und vernetzte Systeme vertiefe ich zusaetzlich im Rahmen meines Masterstudiums und eigener Projekte.",
    cv_skills_title: "Kernkompetenzen",
    cv_skills_list: "Virtualisierung (Proxmox / VMware / VirtualBox), Windows Server, Linux (Debian/Ubuntu), Monitoring/Alerting, Troubleshooting, Git, Jira, Confluence, PowerShell, Bash, Python, TypeScript/JavaScript, XML/XSLT, Networking (TCP/IP / DNS / DHCP / VPN / VLAN), Wireshark, Nmap, Oracle SQL, HTML/CSS, ServiceNow, Power BI, Datenanalyse, Business Analysis, Oxygen XML Editor, ArchiMate/UML/BPMN, ITIL, Scrum",
  ...
  en: {
    ...
    cv_summary_text: "System administrator with experience in operational IT and Windows-based client/server environments. Comfortable with end-user support, ticket handling, structured troubleshooting, networking, system maintenance, software-oriented automation, and application-engineering-adjacent integration work. I am also developing data/process analysis, business-analysis-oriented working methods, and further depth in IoT, security, and connected systems through master's studies and personal projects.",
    cv_skills_title: "Key Skills",
    cv_skills_list: "Virtualization (Proxmox / VMware / VirtualBox), Windows Server, Linux (Debian/Ubuntu), Monitoring/Alerting, Troubleshooting, Git, Jira, Confluence, PowerShell, Bash, Python, TypeScript/JavaScript, XML/XSLT, Networking (TCP/IP / DNS / DHCP / VPN / VLAN), Wireshark, Nmap, Oracle SQL, HTML/CSS, ServiceNow, Power BI, Data Analysis, Business Analysis, Oxygen XML Editor, ArchiMate/UML/BPMN, ITIL, Scrum",
