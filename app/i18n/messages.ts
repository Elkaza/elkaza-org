...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  de: {
    ...
    // Home - Hero
    hero_badge: "Infrastruktur | Anwendungen | Edge AI",
    home_hero_headline: "Ich baue und betreibe praktische technische Systeme.",
    home_hero_subline: "Linux-Infrastruktur, Application Engineering, Automatisierung und vernetzte Geraete",
    home_hero_desc: "Ich arbeite dort, wo Systeme zuverlaessig, verstaendlich und wartbar sein muessen: Linux-Server, Application Support, vernetzte Geraete, Automatisierungsskripte, Dashboards und Dokumentation. Mein Hintergrund verbindet Computernetzwerke und Telekommunikation, operative IT-Erfahrung, Wirtschaftsinformatik an der TU Wien und aktuelle IoT-Projekte an der FH Technikum Wien.",
    ...
    home_platform_title: "Aktuelle Projektbasis",
    home_platform_text: "Die aktuelle Arbeit verbindet produktionsnahe Infrastruktur mit AIoT- und Data-Projekten: self-hosted Plausible und Tailscale-Ingress, EdgeGuardian mit Raspberry Pi 5 und Hailo, TinyML-Inferenz auf Arduino Nano 33 BLE Sense Rev2 sowie Python-Dashboards und ML-Regressionsmodelle.",
    ...
    what_do_subtitle: "Ich verbinde Betriebserfahrung mit sauberer Umsetzung: Infrastruktur, Anwendungen, Automatisierung, Security und Datenarbeit.",
    ...
    current_item4: "Data & Machine Learning: statisches Oesterreich-Tourismus-Dashboard, KMeans-Clustering-Report und Random-Walk-Gravity-Regression mit scikit-learn.",
    ...
    cv_recent_projects_title: "Ausgewaehlte aktuelle Projekte",
    cv_recent_projects_desc: "Aktuelle GitHub-gestuetzte Fallstudien, die Infrastruktur, Edge AI, Embedded TinyML und Data Analysis verbinden.",
    cv_recent_edgeguardian_title: "EdgeGuardian - Edge AI Safety Bubble",
    cv_recent_edgeguardian_desc: "Raspberry Pi 5, Hailo-8L, Kamera, Hokuyo LiDAR und ESP32 fuer lokale SAFE/WARNING/ALERT-Entscheidungen.",
    ...
    cv_recent_tourism_desc: "Python/HTML-Dashboard fuer saisonale Naechtigungsanalyse, Storytelling und statische Visualisierungen.",
  ...
  en: {
    ...
    // Home - Hero
    hero_badge: "Infrastructure | Applications | Edge AI",
    home_hero_headline: "I build and operate practical technical systems.",
    home_hero_subline: "Linux infrastructure, application engineering, automation, and connected devices",
    home_hero_desc: "I work where systems need to be reliable, understandable, and maintainable: Linux servers, application support, networked devices, automation scripts, dashboards, and documentation. My background combines computer networks and telecommunications, operational IT experience, Business Informatics at TU Wien, and current IoT projects at FH Technikum Wien.",
    ...
    home_platform_title: "Current Project Base",
    home_platform_text: "Current work connects production-minded infrastructure with AIoT and data projects: self-hosted Plausible and Tailscale ingress, EdgeGuardian with Raspberry Pi 5 and Hailo, TinyML inference on Arduino Nano 33 BLE Sense Rev2, plus Python dashboards and ML regression models.",
    home_platform_item1: "Self-hosted infrastructure",
    home_platform_item2: "Edge AI safety monitoring",
    ...
    what_do_subtitle: "I connect operational experience with clean implementation: infrastructure, applications, automation, security, and data work.",
