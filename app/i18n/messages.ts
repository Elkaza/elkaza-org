...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  de: {
    ...
    about_exp_summary: "Beruflich komme ich aus IT-Betrieb, Support, Netzwerk- und Prozessumgebungen; IoT ist eine laufende zusätzliche Spezialisierung.",
    ...
    about_strength_2: "Windows-/Linux-nahe Systemadministration und Virtualisierung",
    about_strength_3: "Netzwerkgrundlagen: TCP/IP, DNS, DHCP, VPN, VLAN",
    about_strength_4: "ITSM, ServiceNow, Dokumentation und Runbooks",
    about_strength_5: "Skripting, software-nahe Automatisierung und Integrationsarbeit mit Python, PowerShell und Bash",
    about_strength_6: "Monitoring, Daten-/Prozessanalyse, Self-hosted Infrastruktur und saubere Uebergaben",
    ...
    skill_cloud_title: "Plattformen & laufende IoT-Arbeit",
    skill_cloud_item1: "Proxmox, Docker/Podman, Linux-Services, Reverse Proxy und Monitoring",
    skill_cloud_item2: "Laufende Vertiefung in IoT-Architekturen, Edge-Gateways, MQTT und sicherer Konnektivität",
    skill_cloud_item3: "Praxisnahe Projekte aus Studium, Homelab und eigenem Portfolio",
  ...
  en: {
    ...
    about_strength_2: "Windows/Linux-adjacent system administration and virtualization",
    about_strength_3: "Networking foundations: TCP/IP, DNS, DHCP, VPN, VLAN",
    about_strength_4: "ITSM, ServiceNow, documentation, and runbooks",
    about_strength_5: "Scripting, software-oriented automation, and integration work with Python, PowerShell, and Bash",
    about_strength_6: "Monitoring, data/process analysis, self-hosted infrastructure, and clean handovers",
    ...
    skill_cloud_title: "Platforms & Ongoing IoT Work",
    ...
    skill_cloud_item1: "Proxmox, Docker/Podman, Linux services, reverse proxying, and monitoring",
    skill_cloud_item2: "Ongoing learning in IoT architectures, edge gateways, MQTT, and secure connectivity",
    skill_cloud_item3: "Practical projects from studies, homelab work, and the personal portfolio",
