...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  de: {
    ...
    cv_summary_text: "IT-Infrastruktur-, Plattform- und Automatisierungsprofil mit Erfahrung in operativem IT-Betrieb, Linux-/Windows-Umgebungen, Netzwerken und software-naher Automatisierung. Aktuelle Projektarbeit staerkt hybride Self-Hosted-Infrastruktur mit GitHub Actions, Tailscale, Docker, Nginx Proxy Manager, geskripteten Releases und Backup-Automation.",
    cv_summary_focus1: "Operativer IT-Betrieb",
    cv_summary_focus2: "Hybrid Cloud & Self-Hosting",
    cv_summary_focus3: "CI/CD & Automatisierung",
    ...
    cv_skill_platform_title: "Plattform & Systeme",
    cv_skill_platform_items: "Hybrid Cloud | Proxmox | Docker | Nginx Proxy Manager | Linux (Debian/Ubuntu) | Windows Server",
    cv_skill_automation_title: "Automatisierung & CI/CD",
    cv_skill_automation_items: "GitHub Actions | Bash | PowerShell | Python | rsync | Backup Automation | Git",
    cv_skill_networking_title: "Netzwerke & Security",
    cv_skill_networking_items: "Tailscale | VPN/VLAN | DNS/DHCP | UFW | Wireshark | Nmap",
    cv_skill_operations_title: "Operations & Monitoring",
    cv_skill_operations_items: "Monitoring/Alerting | Troubleshooting | ITSM | ServiceNow | Runbooks | Jira/Confluence",
    cv_skill_software_title: "Software & Daten",
    cv_skill_software_items: "TypeScript/JavaScript | XML/XSLT | Oracle SQL | Power BI | Datenanalyse | Business Analysis",
    cv_skill_delivery_title: "Delivery & Modellierung",
    cv_skill_delivery_items: "ArchiMate/UML/BPMN | ITIL | Scrum | IPMA Level D",
  ...
  en: {
    ...
    cv_summary_text: "IT infrastructure, platform, and automation profile with experience in operational IT, Linux/Windows environments, networking, and software-oriented automation. Current project work strengthens hybrid self-hosted infrastructure with GitHub Actions, Tailscale, Docker, Nginx Proxy Manager, scripted releases, and backup automation.",
    cv_summary_focus1: "Operational IT",
    cv_summary_focus2: "Hybrid Cloud & Self-Hosting",
    cv_summary_focus3: "CI/CD & Automation",
    cv_summary_focus4: "Security & Zero Trust",
    ...
    cv_skill_platform_title: "Platform & Systems",
    cv_skill_platform_items: "Hybrid Cloud | Proxmox | Docker | Nginx Proxy Manager | Linux (Debian/Ubuntu) | Windows Server",
    cv_skill_automation_title: "Automation & CI/CD",
    cv_skill_automation_items: "GitHub Actions | Bash | PowerShell | Python | rsync | Backup Automation | Git",
    ...
    cv_skill_software_items: "TypeScript/JavaScript | XML/XSLT | Oracle SQL | Power BI | Data Analysis | Business Analysis",
    cv_skill_delivery_title: "Delivery & Modeling",
    cv_skill_delivery_items: "ArchiMate/UML/BPMN | ITIL | Scrum | IPMA Level D",
