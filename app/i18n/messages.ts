...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  de: {
    ...
    about_exp_summary: "Kurze Übersicht meines Hintergrunds und meines Fokus:",
    about_exp_highlight1: "Praktische Erfahrung im System Engineering und Netzwerkbetrieb (ISP & Enterprise).",
