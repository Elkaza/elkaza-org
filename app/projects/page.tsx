        ...
        <div className="lg:col-span-9">
          ...
          <div>
            ...
            <div className="relative border-l border-blue-300 dark:border-blue-700 ml-6 pl-6 pb-12">
              ...
              <div className="relative mb-10">
                ...
                <h3 className="text-lg font-semibold text-blue-600 dark:text-blue-400">2025</h3>
                ...
                <div className="space-y-4">
                  <div className="p-4 border border-subtle rounded-lg">
                    <div className="flex items-center mb-1">
                      ...
                      <h4 className="font-semibold">{t("proj_item_web_title")}</h4>
                    </div>
                    <p className="text-sm text-main">{t("proj_item_web_desc")}</p>
                  </div>
                  ...
                  <div className="p-4 border border-subtle rounded-lg">
                    ...
                    <p className="text-sm text-main">{t("proj_item_freertos_desc") ?? ""}</p>
                  </div>
                  ...
                  <div className="p-4 border border-subtle rounded-lg">
                    ...
                    <p className="text-sm text-main">{t("proj_item_infra_desc") ?? ""}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative mb-4">
                ...
                <p className="text-main">{t("proj_2026_desc") ?? ""}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-14">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-xl border border-subtle bg-card flex flex-col h-full">
                <h3 className="font-semibold mb-2 text-lg">{t("proj_cur_web_title")}</h3>
                <p className="text-sm text-muted leading-relaxed break-words">{t("proj_cur_web_desc")}</p>
              </div>
              <div className="p-6 rounded-xl border border-subtle bg-card flex flex-col h-full">
                <h3 className="font-semibold mb-2 text-lg">{t("proj_cur_freertos_title") ?? "FreeRTOS Sensor Node"}</h3>
                <p className="text-sm text-muted leading-relaxed break-words">{t("proj_cur_freertos_desc") ?? ""}</p>
              </div>
              <div className="p-6 rounded-xl border border-subtle bg-card flex flex-col h-full">
                <h3 className="font-semibold mb-2 text-lg">{t("proj_cur_infra_title") ?? "Self-Hosted Infra"}</h3>
                <p className="text-sm text-muted leading-relaxed break-words">{t("proj_cur_infra_desc") ?? ""}</p>
              </div>
              <div className="p-6 rounded-xl border border-subtle bg-card flex flex-col h-full">
                <h3 className="font-semibold mb-2 text-lg">{t("proj_cur_notes_title") ?? "EA + AI Notes Assistant"}</h3>
                <p className="text-sm text-muted leading-relaxed break-words">{t("proj_cur_notes_desc") ?? ""}</p>
              </div>
            </div>
          </div>
        </div>
