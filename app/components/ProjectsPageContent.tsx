...
const COPY: Record<string, Copy> = {
    en: {
        ...
        title: "Data automation, IoT, infrastructure, applications, and delivery work",
        intro: "This portfolio shows role-relevant work across data automation, IoT and edge AI, IT operations, application engineering, software automation, cybersecurity-minded infrastructure, project delivery, and business analysis. The projects are written as case studies to show requirements, system design, troubleshooting, evidence, and production-minded delivery.",
        highlights: [
            "Data and ML: Python, scikit-learn, dashboards, CSV validation, reproducible reports",
            "IoT and edge: Raspberry Pi, Hailo, LiDAR, Arduino Nano 33 BLE Sense Rev2, ESP32",
            "Operations: Linux, Docker, Tailscale, monitoring, documentation, handovers",
        ],
        ...
        categoryLabels: {
            ...
            "platform-component": "Data & Automation",
            "delivery-platform": "Business Informatics / Web",
        },
    },
    de: {
        eyebrow: "Portfolio",
        title: "Datenautomatisierung, IoT, Infrastruktur, Anwendungen und Delivery",
        intro: "Das Portfolio zeigt rollenrelevante Arbeit über Datenautomatisierung, IoT und Edge AI, IT Operations, Application Engineering, Software-Automatisierung, security-orientierte Infrastruktur, technische Projektumsetzung und Business Analysis hinweg. Die Projekte sind als Fallstudien aufgebaut, um Anforderungen, Systemdesign, Troubleshooting, Evidenz und produktionsnahes Denken sichtbar zu machen.",
        highlights: [
            "Data und ML: Python, scikit-learn, Dashboards, CSV-Validierung, reproduzierbare Reports",
            "IoT und Edge: Raspberry Pi, Hailo, LiDAR, Arduino Nano 33 BLE Sense Rev2, ESP32",
            "Operations: Linux, Docker, Tailscale, Monitoring, Dokumentation, Übergaben",
        ],
        ...
        categoryLabels: {
            ...
            "featured-aiot": "IoT / Edge AI",
            "platform-component": "Data & Automation",
            "delivery-platform": "Wirtschaftsinformatik / Web",
        },
    },
    ar: {
        eyebrow: "Engineering Portfolio",
