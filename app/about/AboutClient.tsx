    ...
    <main className="min-h-screen bg-[var(--bg)] text-gray-900 dark:text-gray-100 transition-colors">
      <section className="max-w-6xl mx-auto px-6 py-12 lg:grid lg:grid-cols-12 lg:gap-10">
        ...
        <div className="lg:col-span-9">
          <p className="text-lg text-dim mb-8">{t("about_lead") ?? ""}</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
            ...
            <div>
              ...
              <p className="text-dim leading-relaxed mb-4">{t("about_p1") ?? ""}</p>
              <p className="text-dim leading-relaxed mb-4">{t("about_p2") ?? ""}</p>
              <p className="text-dim leading-relaxed">{t("about_p3") ?? ""}</p>
            </div>
          </div>

          <div className="rounded-xl p-6 bg-[var(--surface-2)] border border-[var(--outline)] shadow-elev-1">
