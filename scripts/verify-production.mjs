...
const routePairs = [
  {
    ...
    de: "/",
    en: "/en",
    deText: ["Deutsch", "Englisch", "B2", "C1", "Aktuelle akademische Arbeit", "Secure Edge AI Gateway for IoT Networks (Arbeitstitel)"],
    enText: ["German", "English", "B2", "C1", "Current Academic Work", "Secure Edge AI Gateway for IoT Networks (Working title)"],
  },
  {
    name: "about",
    de: "/about",
    en: "/en/about",
    deText: ["Mohamed Elkaza", "Aktuelle akademische Arbeit", "MIO-3 Master&#x27;s Project", "Secure Edge AI Gateway for IoT Networks (Arbeitstitel)"],
    enText: ["Mohamed Elkaza", "Current Academic Work", "MIO-3 Master&#x27;s Project", "Secure Edge AI Gateway for IoT Networks (Working title)"],
  },
  {
    name: "projects",
    de: "/projects",
  ...
  },
  {
    ...
    de: "/cv",
    en: "/en/cv",
    deText: ["Lebenslauf", "Application Engineer", "Masterstudium Wirtschaftsinformatik", "Angestrebter Abschlussgrad: Diplom-Ingenieur", "Aktuelle akademische Arbeit", "Secure Edge AI Gateway for IoT Networks (Arbeitstitel)", "Systematische Literaturrecherche · Analyse österreichischer Stellenanzeigen · Design Science Research", "Forschung ansehen"],
    enText: ["CV", "Application Engineer", "Programme in Business Informatics", "Target degree: Diplom-Ingenieur", "Current Academic Work", "Secure Edge AI Gateway for IoT Networks (Working title)", "Systematic Literature Review · Austrian Job-Ad Analysis · Design Science Research", "View research"],
    forbiddenText: ["exp1_title", "exp1_desc", "exp2_title", "exp2_desc", "exp3_title", "exp3_desc", "exp4_title", "exp4_desc", "MSc Wirtschaftsinformatik", "MSc Business Informatics", "Abschlussgrad bei erfolgreichem Abschluss", "Degree upon successful completion"],
  },
  {
    name: "research",
    de: "/research",
    en: "/en/research",
    deText: ["Aktuelle akademische Arbeit", "Enterprise Coherence Governance", "Henderik A. Proper", "Secure Edge AI Gateway for IoT Networks (Arbeitstitel)", "konkreter Umfang derzeit mit dem Betreuer abgestimmt", "Integrationsrahmen / Metamodell zur Darstellung der Beziehungen zwischen Methoden, Disziplinen, Rollen, Artefakten und Governance-Mechanismen."],
    enText: ["Current Academic Work", "Enterprise Coherence Governance", "Henderik A. Proper", "Secure Edge AI Gateway for IoT Networks (Working title)", "detailed scope is currently being defined with the supervisor", "Integration framework / metamodel representing relationships between methods, disciplines, roles, artifacts, and governance mechanisms."],
    forbiddenText: ["Full text on request", "Volltext auf Anfrage", "final framework", "final research question", "prototype already exists"],
  },
  {
    name: "contact",
    de: "/kontakt",
