...
const routePairs = [
  {
    ...
    de: "/",
    en: "/en",
    deText: ["Deutsch", "Englisch", "B2", "C1", "Aktuelle akademische Arbeit", "TU Wien Diplomarbeit", "Themen- und Betreuungsabstimmung", "Secure Edge AI Gateway for IoT Networks (Arbeitstitel)"],
    enText: ["German", "English", "B2", "C1", "Current Academic Work", "TU Wien Diploma Thesis", "Topic and supervision under clarification", "Secure Edge AI Gateway for IoT Networks (Working title)"],
  ...
  },
  {
    ...
    de: "/projects",
    en: "/en/projects",
    deText: ["EdgeGuardian", "Software Engineering"],
    enText: ["EdgeGuardian", "software engineering"],
  },
  {
    name: "cv",
    de: "/cv",
