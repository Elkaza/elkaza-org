...
const routePairs = [
  {
    ...
    de: "/",
    en: "/en",
    deText: ["Deutsch", "Englisch", "B2", "C1", "Aktuelle akademische Arbeit", "Secure Edge AI Gateway for IoT Networks"],
    enText: ["German", "English", "B2", "C1", "Current Academic Work", "Secure Edge AI Gateway for IoT Networks"],
  },
  {
    name: "about",
    de: "/about",
    en: "/en/about",
    deText: ["Mohamed Elkaza", "Aktuelle akademische Arbeit", "MIO-3 Master&#x27;s Project"],
    enText: ["Mohamed Elkaza", "Current Academic Work", "MIO-3 Master&#x27;s Project"],
  },
  {
    name: "projects",
    de: "/projects",
  ...
  },
  {
    ...
    de: "/cv",
    en: "/en/cv",
    deText: ["Lebenslauf", "Application Engineer", "Masterstudium Wirtschaftsinformatik", "Diplom-Ingenieur", "Aktuelle akademische Arbeit", "Secure Edge AI Gateway for IoT Networks"],
    enText: ["CV", "Application Engineer", "Programme in Business Informatics", "Diplom-Ingenieur", "Current Academic Work", "Secure Edge AI Gateway for IoT Networks"],
  ...
  },
  {
    ...
    de: "/research",
    en: "/en/research",
    deText: ["Aktuelle akademische Arbeit", "Enterprise Coherence Governance", "Henderik A. Proper", "Secure Edge AI Gateway for IoT Networks", "konkreter Umfang derzeit mit dem Betreuer abgestimmt"],
    enText: ["Current Academic Work", "Enterprise Coherence Governance", "Henderik A. Proper", "Secure Edge AI Gateway for IoT Networks", "detailed scope is currently being defined with the supervisor"],
